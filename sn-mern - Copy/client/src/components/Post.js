...
const Post = ({ post }) => {
  ...
  const handleDelete = id => {
    dispatch(deletePost(id, post.image.public_id));
  };
  ...
  return (
    <Col lg={4} className='mb-4'>
      <div className='d-flex align-items-center user-post-info'>
        <Image fluid src={post?.user.avatar.url} />
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text className='pt-3 mb-0'>{post.description}</Card.Text>
